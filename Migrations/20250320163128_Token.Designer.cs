...
namespace ASP_P22.Migrations
{
    ...
    [Migration("20250320163128_Token")]
    partial class Token
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.AuthToken", b =>
                {
                    b.Property<Guid>("Jti")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.Promotion", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.Rate", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.UserRole", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.AuthToken", b =>
                {
                    b.HasOne("ASP_P22.Data.Entities.UserAccess", "UserAccess")
                        .WithMany()
                        .HasForeignKey("Sub");
            ...
            modelBuilder.Entity("ASP_P22.Data.Entities.UserAccess", b =>
                {
                    b.HasOne("ASP_P22.Data.Entities.UserRole", "Role")
                        .WithMany()
            ...
            modelBuilder.Entity("ProductPromotion", b =>
                {
                    b.HasOne("ASP_P22.Data.Entities.Product", null)
                        .WithMany()
                        .HasForeignKey("ProductsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("ASP_P22.Data.Entities.Promotion", null)
                        .WithMany()
